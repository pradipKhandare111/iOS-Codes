...
@IBDesignable public class GMStepper: UIControl {
    ...
    */
    ...
    func setup() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(GMStepper.reset), name: NSNotification.Name.UIApplication.willResignActiveNotification, object: nil)
    }
